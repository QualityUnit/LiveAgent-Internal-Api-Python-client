...
class EventsApi:
    ...
    def execute_handler(self, handler_payload : Optional[HandlerPayload] = None, async_req: Optional[bool]=None, **kwargs) -> Union[None, Awaitable[None]]:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the execute_handler_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
    ...
    def get_event_consumers(self, async_req: Optional[bool]=None, **kwargs) -> Union[List[Consumer], Awaitable[List[Consumer]]]:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_event_consumers_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        if async_req is not None:
            kwargs['async_req'] = async_req
